...
export class SettingsButton {
  ...
  constructor(dependencyTree: DependencyTree, stepHeight: number) {
    ...
    this.rippleAnimation = new RippleAnimation(this.rippleCircle, dependencyTree.treeLayer);
  }
  ...
  private _initHoverEvents(): void {
    this.konvaObject.on('mouseenter', () => {
      this._dependencyTree.cursorState.setCursor(Cursor.POINTER);
    });
    this.konvaObject.on('mouseleave', () => {
      this._dependencyTree.cursorState.unsetCursor(Cursor.POINTER);
    });
  }
