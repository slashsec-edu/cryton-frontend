...
/**
 * Font size of the label inside the node circle.
 */
export const LABEL_FONT_SIZE = 10;

/**
 * Padding inside the leading tick time mark.
 * Indexes: vertical, horizontal.
 */
export const LT_PADDING = [4, 10];

/**
 * Font size of text inside the leading tick time mark.
 */
