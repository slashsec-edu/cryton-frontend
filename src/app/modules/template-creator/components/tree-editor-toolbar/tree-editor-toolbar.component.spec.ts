...
const ACTIVE_CLASS_NAME = 'dependency-tree--active';
...
describe('TreeEditorToolbarComponent', () => {
  ...
  const depTreeStub = jasmine.createSpyObj('DependencyTree', [], { toolState: toolStateStub }) as DependencyTree;
